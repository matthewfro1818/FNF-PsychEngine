...
function floraChar()
{
    ...
    if (game.gf != null && game.gf.curCharacter == 'flora') return game.gf;
    if (game.dad != null && game.dad.curCharacter == 'flora') return game.dad;
    if (game.boyfriend != null && game.boyfriend.curCharacter == 'flora') return game.boyfriend;
    return null;
}
